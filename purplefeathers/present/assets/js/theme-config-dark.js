...
var themeConfig = {
    ...
    build: function () {
		...
		var themeConfigHalloween = this.container.find('ul[data-type=halloween]');
        var themeHalloweenLink = $('<li />').append(
                $('<a />')
                .attr({'href': 'http://eazzy.me/html/imevent-halloween/','title': 'Halloween version'})
                .html('Halloween version').addClass('halloween-settings-link reset-settings-link')
        );
		themeConfigHalloween.append(themeHalloweenLink);
        
        var themeChristmasLink = $('<li />').append(
                $('<a />')
                .attr({'href': 'http://eazzy.me/html/imevent-christmas/','title': 'Christmas version'})
                .html('Christmas version').addClass('christmas-settings-link reset-settings-link')
        );
		themeConfigHalloween.append(themeChristmasLink);
        
        var themeNewYearLink = $('<li />').append(
                $('<a />')
                .attr({'href': 'http://eazzy.me/html/imevent-new-year/','title': 'New Year version'})
        ...
        var themeThanksgivingLink = $('<li />').append(
                $('<a />')
                .attr({'href': 'http://eazzy.me/html/imevent-thanksgiving/','title': 'Thanksgiving Day version'})
		...
		var themeCircleVersionLink = $('<li />').append(
                $('<a />')
                .attr({'href': 'http://eazzy.me/html/imevent/index-circle.html','title': 'Circle version'})
		...
		var themeWithoutHexagonLink = $('<li />').append(
                $('<a />')
                .attr({'href': 'http://eazzy.me/html/imevent/index-wohex.html','title': 'Without Hexagon version'})
        ...
        var themeVideBgLink = $('<li />').append(
            $('<a />')
                .attr({'href': 'http://eazzy.me/html/imevent/index-video.html','title': 'Video Background'})
		...
		var themeMultipageVersionLink = $('<li />').append(
                $('<a />')
                .attr({'href': 'http://eazzy.me/html/imevent-multipage/','title': 'Multipage version'})

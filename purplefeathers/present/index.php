...
<div class="wrapper">
    ...
    <div class="content-area">
        ...
        <section class="page-section no-padding background-img-slider">
            ...
            <img src="img/full.png" class="header-side-img"/>
            ...
            <div id="main-slider" class="owl-carousel owl-theme">
                                ...
                                <div class="div-cell">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-lg-8">
                                            <h2 class="caption-title" data-animation="fadeInDown" data-animation-delay="100"><span>purple feathers</span></h2>
                                            <h3 class="caption-subtitle" data-animation="fadeInUp" data-animation-delay="300">something cool</h3>
                        ...
                        <div class="div-cell">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-8">
                                    ...
                                    <h2 class="caption-title">Purple Feathers</h2>
                                    <h3 class="caption-subtitle">something cool</h3>
                                    </div>
                                </div>
                            </div>
                            <!-- Event description -->
                ...
                <!-- Slide -->
                <div class="item page text-center slide2">
                    <div class="caption">
                    <div class="container">
                        <div class="div-table">
                        <div class="div-cell">
                            <div class="row">
                                ...
                                <div class="col-md-6 col-lg-8">
                                    <h2 class="caption-title"><span>Date of any Event</span></h2>
                                    <h3 class="caption-subtitle">that event</h3>
                                    <!--p class="caption-text">
        ...
        <section class="page-section" id="about">
            <div class="container">
                <h1 class="section-title">
                    ...
                    <span data-animation="fadeInRight" data-animation-delay="500" class="title-inner">About Us<small>/ What is Purple Feathers ?</small></span>
                </h1>
                <div class="row">
                    <div class="col-lg-8">
                        <p data-animation="fadeInUp" data-animation-delay="300">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Donec ligula urna, malesuada ac lacus at, ultrices aliquet lorem. Vivamus dignissim posuere scelerisque. Quisque sed dapibus quam. Maecenas porttitor gravida mi, sed imperdiet lorem pharetra quis. Aenean sed sem porttitor, aliquet orci eu, scelerisque lorem. Praesent maximus orci eget auctor sagittis. Maecenas ullamcorper, orci ac vulputate venenatis, ex dolor placerat nibh, ac fringilla nisi turpis a elit.</p>
        ...
        <!-- Donation -->
        <section class="page-section color" id="donation" style="display:none">
            <div class="container">
                <h1 class="section-title">
        ...
        <!-- PAGE EVENTS -->
        <section class="page-section light" id="events">
            <div class="container">
                <div class="row">
                    <div class="col-md-8 pull-left">
                        <h1 class="section-title">
                            <span data-animation="flipInY" data-animation-delay="300" class="icon-inner"><span class="fa-stack"><i class="fa rhex fa-stack-2x"></i><i class="fa fa-star fa-stack-1x"></i></span></span>
                            <span data-animation="fadeInRight" data-animation-delay="500" class="title-inner">Events <small> / This is what we do</small></span>
                        </h1>
                    </div>
                ...
                <div class="schedule-wrapper clear" data-animation="fadeIn" data-animation-delay="200">
                    <div class="schedule-tabs lv1">
                        <ul id="tabs-lv1"  class="nav nav-justified">
                            <li class="active"><a href="#tab-first" data-toggle="tab"><strong>Programs & Events</strong><br/></a></li>
                            <li><a href="#tab-second" data-toggle="tab"><strong>corporate gifting</strong><br/></a></li>
                            <li><a href="#tab-last" data-toggle="tab"><strong>theme parties</strong><br/></a></li>
                        ...
                        <div id="tab-first" class="tab-pane fade in active">
                            <div class="schedule-tabs lv2">
                                <ul id="tabs-lv21"  class="nav nav-justified">
                                    <li class="active"><a href="#tab-lv21-first" data-toggle="tab">Mumbai</a></li>
                                    <li><a href="#tab-lv21-second" data-toggle="tab">Bangalore</a></li>
                                    <li><a href="#tab-lv21-third" data-toggle="tab">Pune</a></li>
                                    <li><a href="#tab-lv21-last" data-toggle="tab">Delhi</a></li>
                                </ul>
                            </div>
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="post-header">
                                                        ...
                                                        <h2 class="post-title"><a href="#" data-toggle="modal" data-target="#first">Event Content Header Is Header</a></h2>
                                                    </div>
                                                    <div class="post-body">
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <div class="post-header">
                                                        ...
                                                        <h2 class="post-title"><a href="#">Event Content Header Is Header</a></h2>
                                                    </div>
                                                    <div class="post-body">
                                                        <div class="post-excerpt">
                                                            <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed vitae diam metus. Donec cursus magna eget sem convallis facilisis. Vestibulum dictum nibh at ullamcorper tincidunt. Phasellus scelerisque nisl non ullamcorper pellentesque. Nunc sagittis, felis in feugiat mollis, libero eros consectetur elit non cursus lacus nisl at dolor.</p>
                        ...
                        <div id="tab-second" class="tab-pane fade">
                            <div class="schedule-tabs lv2">
                                <ul id="tabs-lv22"  class="nav nav-justified">
                                    <li class="active"><a href="#tab-lv22-first" data-toggle="tab">Mumbai</a></li>
                                    <li><a href="#tab-lv22-second" data-toggle="tab">Bangalore</a></li>
                                    <li><a href="#tab-lv22-third" data-toggle="tab">Pune</a></li>
                                    <li><a href="#tab-lv22-last" data-toggle="tab">Delhi</a></li>
                                </ul>
                            </div>
                            <div class="tab-content lv2">
                        ...
                        <div id="tab-third" class="tab-pane fade">
                            <div class="schedule-tabs lv2">
                                <ul id="tabs-lv23"  class="nav nav-justified">
                                    <li class="active"><a href="#tab-lv23-first" data-toggle="tab">Mumbai</a></li>
                                    <li><a href="#tab-lv23-second" data-toggle="tab">Bangalore</a></li>
                                    <li><a href="#tab-lv23-third" data-toggle="tab">Pune</a></li>
                                    <li><a href="#tab-lv23-last" data-toggle="tab">Delhi</a></li>
                                </ul>
                            </div>
                            <div class="tab-content lv2">
                        ...
                        <div id="tab-last" class="tab-pane fade">
                            <div class="schedule-tabs lv2">
                                <ul id="tabs-lv24"  class="nav nav-justified">
                                    <li class="active"><a href="#tab-lv24-first" data-toggle="tab">Mumbai</a></li>
                                    <li><a href="#tab-lv24-second" data-toggle="tab">Bangalore</a></li>
                                    <li><a href="#tab-lv24-third" data-toggle="tab">Pune</a></li>
                                    <li><a href="#tab-lv24-last" data-toggle="tab">Delhi</a></li>
                                </ul>
                            </div>
                            <div class="tab-content lv2">
        ...
        <div class="modal fade" id="first" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
          <div id='veil'></div>
            ...
            <div id='grid'></div>
              <div id="dismissal" style="position:fixed;top:0;right:1%;z-index:3;font-size:xx-large;background-color: #B503BA;box-shadow:purple 1px 0px 2px;cursor:pointer;border-radius: 50%;width: 2em;height: 2em;">
                <span data-dismiss="modal" class="glyphicon glyphicon-remove" aria-hidden="true" style="top: 17%;left: 17%;font-size:1.4em;"></span>
              </div>
        </div>
        <!-- /PAGE EVENTS -->
        ...
        <section class="page-section" id="clients">
            <div class="container">
                <h1 class="section-title">
                    ...
                    <span data-animation="fadeInRight" data-animation-delay="100" class="title-inner">Our Clients <small> / they are the best</small></span>
                </h1>
                ...
                <div class="text-center margin-top">
                    <a data-animation="flipInY" data-animation-delay="500" href="#" class="btn btn-theme"><i class="fa fa-thumbs-up"></i> Become a client</a>
                </div>
            </div>
        </section>
        <!-- /PAGE CLIENTS -->
        ...
        <section class="page-section light" id="team">
            <div class="container">
                <h1 class="section-title">
                    ...
                    <span data-animation="fadeInUp" data-animation-delay="500" class="title-inner">Our Team <small> / meet with greaters</small></span>
                </h1>
                ...
                <!-- <div class="text-center margin-top">
                    <a data-animation="fadeInUp" data-animation-delay="100" href="#" class="btn btn-theme"><i class="fa fa-user"></i> See our entire team</a>
                </div>
 -->            </div>
        </section>
        <!-- /PAGE TEAM -->
                ...
                <div class="row">
                    <div class="col-md-8 pull-left">
                        <h1 class="section-title">
                            ...
                            <span data-animation="fadeInRight" data-animation-delay="500" class="title-inner">Services <small> / we provide the best ones </small></span>
                        </h1>
                    </div>
                    <div class="col-md-4 text-right-md pull-right">
                        <a href="#" class="btn btn-theme btn-theme-lg btn-theme-transparent-grey pull-right"
                           data-animation="flipInY" data-animation-delay="700"><i class="fa fa-pencil"></i> Subscribe </a>
                    </div>
                </div>
                <div class="row faq margin-top" data-animation="fadeInUp" data-animation-delay="100">
                    <div class="col-sm-6 col-md-6 pull-left">
                        <ul id="tabs-faq"  class="nav">
                            <li class="active"><a href="#tab-faq1" data-toggle="tab"><i class="fa fa-angle-right"></i> <span class="faq-inner">Service 1</span></a></li>
                            <li><a href="#tab-faq2" data-toggle="tab"><i class="fa fa-plus"></i> <span class="faq-inner">Service 2</span></a></li>
                            <li><a href="#tab-faq3" data-toggle="tab"><i class="fa fa-plus"></i> <span class="faq-inner">Service 3</span></a></li>
                            <li><a href="#tab-faq4" data-toggle="tab"><i class="fa fa-plus"></i> <span class="faq-inner">Service 4</span></a></li>
                        </ul>
                    </div>
